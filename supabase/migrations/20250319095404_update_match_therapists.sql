-- Update match_therapists function to include location filtering
...
IS 'Matches therapists based on embedding similarity and filters, including city and province filtering';

-- Create indices to improve location filtering performance
CREATE INDEX IF NOT EXISTS idx_therapist_clinic_city ON therapists(clinic_city);
CREATE INDEX IF NOT EXISTS idx_therapist_clinic_province ON therapists(clinic_province);
