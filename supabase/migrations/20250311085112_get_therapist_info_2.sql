...
-- SELECT get_therapist_info_v2('Kevin', 'Kraussler');

SELECT get_therapist_info_v2('Jessica', 'Atnikov');
SELECT get_therapist_info_v2('Dimi', 'Nikolarakos');
SELECT get_therapist_info_v2('Christianne', 'Zamorano');
SELECT get_therapist_info_v2('Carlos', 'Dominguez');
SELECT get_therapist_info_v2('Ryan', 'Newman');
SELECT get_therapist_info_v2('Andy', 'De Bruyns');
SELECT get_therapist_info_v2('Alia', 'Mai');
SELECT get_therapist_info_v2('Nicole', 'Che');
