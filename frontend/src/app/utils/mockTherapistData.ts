...
export const mockTherapistProfile: TherapistProfile = {
  ...
  title: "Licensed Psychologist",
  bio:
    "I am a licensed psychologist with over 10 years of experience helping individuals overcome anxiety, depression, and trauma. My approach is collaborative, warm, and evidence-based. I believe in creating a safe space where clients can explore their thoughts and feelings without judgment.",
  areas_of_focus: [
    "Anxiety",
    "Depression",
    "Trauma",
  ...
  short_summary:
    "Specializing in anxiety, depression, and trauma using evidence-based approaches.",
  qualifications: [
