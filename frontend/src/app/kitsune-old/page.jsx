...
const Chatbot = () => {
  const { chatId: newChatId, setChatId: setNewChatId } = useChatSession();
  console.log("Chatbot", { newChatId });
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch(
        `https://dm9k979b9h.execute-api.us-west-2.amazonaws.com/api/chat`,
        {
          method: "POST",
          headers: {
