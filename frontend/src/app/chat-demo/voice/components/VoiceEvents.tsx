...
import { useVoiceEvent } from "../../voice/contexts/VoiceEventContext";
...
function Events({ isExpanded }: EventsProps) {
  ...
  const { loggedEvents, toggleExpand } = useVoiceEvent();
                ...
                >
                  ...
                  >
                    <div className="flex items-center flex-1">
                      ...
                      <span
                        className={"flex-1 text-sm " + (isError ? "text-red-600" : "text-gray-800")}
                      >
                        {log.eventName}
                      </span>
                    </div>
